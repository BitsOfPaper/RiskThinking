...
-- Calculated moving average of the trading volume and rolling median of adj close for 30 days per each stock and ETF
"""
...
-- Used 80% rows from each stock/etf for training

-- Used Light GBM for prediction. It uses less memory compared to Random Forest and reduced training time.
"""
